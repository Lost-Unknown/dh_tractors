...
const Transfer_Invoice = () => {
  ...
  useEffect(() => {
    const getDetails = async () => {
      const response = await fetch(`/api/stocktransfer/${id}`);
      ...
      data.actualinvoice = "S" + (data.invoice > 9 ? "" : "0") + data.invoice;
      ...
      <div ref={contentRef} className="flex flex-col w-full px-8">
          ...
          <div className="w-full flex">
            ...
            <div className="flex flex-col w-5/12">
              ...
              <div className="flex text-sm w-full">
                ...
                <h1 className="w-7/12">: R.D. Sale</h1>
              </div>
            </div>
          </div>
        ...
        <div className="w-full flex flex-col items-start">
          ...
          <div className="w-full">
            <TractorTable data={post} isImplement={post.isImplement} />
          </div>
        </div>
...
export default Transfer_Invoice;
