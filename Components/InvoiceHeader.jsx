  ...
  return (
    <div className='w-full'>
                <div className='w-full flex relative'>
                    <Image priority={true} className=' absolute mt-4' src="/swarajLogo.png" width={160} height={40} alt='Logo'/>
                    <div className=' w-full mt-6 flex flex-col justify-center items-center'>
                        <h1 className='font-bold text-3xl'>DH TRACTORS</h1>
                        <h1>(Authorised Dealer for Swaraj Tractor Sales, Service and Spares)</h1>
                    </div>
                </div>
                <div className='w-full flex justify-between items-end'>
                    <h2 className='font-bold text-sm'>GSTIN - 07IFFPS4147A1ZG</h2>
                    <div className='flex flex-col justify-end items-end'>
                        <h2 className=' text-xs'>GEETANJALI COLONY, BABA HARI DAS NAGAR ROAD,</h2>
